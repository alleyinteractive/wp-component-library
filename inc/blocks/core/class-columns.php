<?php
/**
 * WP Component Library includes: Columns Block class
 *
...
/**
 * Renders a Columns block as a WPCL component.
 */
class Columns extends Anonymous {
	...
	public function render(): void {
		...
		$this->attrs['columns'] = $this->raw['innerBlocks'];
